    ...
    <ul>
        <li class="current"><a href="#formsub" class="editor">用户管理</a>
            ...
            <ul id="formsub">
                ...
                <li class="current"><a href="{{url('admin/user/list')}}">查看用户</a></li>
            </ul>
        </li>
    </ul>
@stop
...
@section('content')
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="tableoptions">
            <button class="deletebutton radius3" title="table1" url="{{url('admin/user/delete')}}">删除</button> &nbsp;
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table1" class="stdtable stdtablecb">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center"><a href="{{url('admin/user/add',['id'=>$val->id])}}">修改</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
